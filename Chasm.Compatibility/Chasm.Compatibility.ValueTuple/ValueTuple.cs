...
namespace System
{
    ...
    public struct ValueTuple
        ...
        , IComparable, IComparable<ValueTuple>
        , IValueTupleInternal
#if NETCOREAPP1_0_OR_GREATER || NETSTANDARD1_0_OR_GREATER || NET40_OR_GREATER
    ...
    public struct ValueTuple<T1>
        ...
        , IComparable, IComparable<ValueTuple<T1>>
        , IValueTupleInternal
#if NETCOREAPP1_0_OR_GREATER || NETSTANDARD1_0_OR_GREATER || NET40_OR_GREATER
        , IStructuralEquatable, IStructuralComparable
#endif
...
#endif
    {
        ...
        public override int GetHashCode()
        {
            return ShimHashCode.Combine(Item1?.GetHashCode() ?? 0,
                                    Item2?.GetHashCode() ?? 0);
        }

        private int GetHashCodeCore(IEqualityComparer comparer)
        {
            return ShimHashCode.Combine(comparer.GetHashCode(Item1!),
        ...
        where TRest : struct
    {
        ...
        public override int GetHashCode()
        {
            ...
            {
                case 1:
                    return ShimHashCode.Combine(Item7?.GetHashCode() ?? 0,
                                            restHashCode);
                case 2:
                    return ShimHashCode.Combine(Item6?.GetHashCode() ?? 0,
                                            Item7?.GetHashCode() ?? 0,
                                            restHashCode);
                case 3:
                    return ShimHashCode.Combine(Item5?.GetHashCode() ?? 0,
                                            Item6?.GetHashCode() ?? 0,
                                            Item7?.GetHashCode() ?? 0,
                                            restHashCode);
                case 4:
                    return ShimHashCode.Combine(Item4?.GetHashCode() ?? 0,
                                            Item5?.GetHashCode() ?? 0,
                                            Item6?.GetHashCode() ?? 0,
                                            Item7?.GetHashCode() ?? 0,
                                            restHashCode);
                case 5:
                    return ShimHashCode.Combine(Item3?.GetHashCode() ?? 0,
                                            Item4?.GetHashCode() ?? 0,
                                            Item5?.GetHashCode() ?? 0,
                                            Item6?.GetHashCode() ?? 0,
                                            Item7?.GetHashCode() ?? 0,
                                            restHashCode);
                case 6:
                    return ShimHashCode.Combine(Item2?.GetHashCode() ?? 0,
                                            Item3?.GetHashCode() ?? 0,
                                            Item4?.GetHashCode() ?? 0,
                                            Item5?.GetHashCode() ?? 0,
                                            Item6?.GetHashCode() ?? 0,
        ...
        private int GetHashCodeCore(IEqualityComparer comparer)
        {
            ...
            {
                return ShimHashCode.Combine(comparer.GetHashCode(Item1!), comparer.GetHashCode(Item2!), comparer.GetHashCode(Item3!),
            ...
            {
                case 1:
                    return ShimHashCode.Combine(comparer.GetHashCode(Item7!),
                                            restHashCode);
                case 2:
                    return ShimHashCode.Combine(comparer.GetHashCode(Item6!),
                                            comparer.GetHashCode(Item7!),
                                            restHashCode);
                case 3:
                    return ShimHashCode.Combine(comparer.GetHashCode(Item5!),
                                            comparer.GetHashCode(Item6!),
                                            comparer.GetHashCode(Item7!),
                                            restHashCode);
                case 4:
                    return ShimHashCode.Combine(comparer.GetHashCode(Item4!),
                                            comparer.GetHashCode(Item5!),
                                            comparer.GetHashCode(Item6!),
                                            comparer.GetHashCode(Item7!),
                                            restHashCode);
                case 5:
                    return ShimHashCode.Combine(comparer.GetHashCode(Item3!),
                                            comparer.GetHashCode(Item4!),
                                            comparer.GetHashCode(Item5!),
                                            comparer.GetHashCode(Item6!),
                                            comparer.GetHashCode(Item7!),
                                            restHashCode);
                case 6:
                    return ShimHashCode.Combine(comparer.GetHashCode(Item2!),
                                            comparer.GetHashCode(Item3!),
                                            comparer.GetHashCode(Item4!),
                                            comparer.GetHashCode(Item5!),
                                            comparer.GetHashCode(Item6!),
